...
#ifndef FREESTEAM_SOLVER3_H
#define FREESTEAM_SOLVER3_H
...
*/
FREESTEAM_DLL SteamState freesteam_solver3_region1(FREESTEAM_CHAR X, FREESTEAM_CHAR Y, double x, double y, SteamState guess, int *status);
FREESTEAM_DLL SteamState freesteam_solver3_region2(FREESTEAM_CHAR X, FREESTEAM_CHAR Y, double x, double y, SteamState guess, int *status);
FREESTEAM_DLL SteamState freesteam_solver3_region3(FREESTEAM_CHAR X, FREESTEAM_CHAR Y, double x, double y, SteamState guess, int *status);
FREESTEAM_DLL SteamState freesteam_solver3_region4(FREESTEAM_CHAR X, FREESTEAM_CHAR Y, double x, double y, SteamState guess, int *status);
